...
class Hillclimber():
    ...
    def swap_with_random_rotation(self, start_map):
        ...
        # coordinaten omwisselen
        # copy_coordinates_house1 = deepcopy(house1.bottom_left)
        # new_coordinates_house1 = house2.bottom_left
        # new_coordinates_house2 = copy_coordinates_house1
        ...
        #house 2 naar house 1 locatoe
        rotation_finished = rotation(house1.bottom_left, house2.width, house2.depth, placement, house2.free_space)
        width = rotation_finished[0]
        depth = rotation_finished[1]
        polygon = rotation_finished[2]
        polygon_free_space = rotation_finished[3]
        ...
        if copy_start_map.check_valid(house2) == True and copy_start_map.check_valid(house1) == True:
    ...
    def run(self, iterations, empty_graph, number_houses):
        highest_scoring_map = Randomise(empty_graph, number_houses, 400).winner
        print(highest_scoring_map.total)
        highest_score = 0
